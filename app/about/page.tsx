...
const values = [
  ...
  { title: "Quality First", color: "#2563EB", icon: "Star" as const },
  { title: "Transparent", color: "#7C3AED", icon: "Eye" as const },
  { title: "Client Focused", color: "#EA580C", icon: "Heart" as const },
];

const members = [
  { name: "Amina R.", role: "Product Engineer", color: "from-[#2563EB] to-[#1D4ED8]" },
    ...
    <main className="section-shell bg-white py-16">
      <div className="container-shell">
        <section className="relative overflow-hidden rounded-3xl bg-white py-14 text-center">
          <div className="pointer-events-none absolute -left-16 top-10 h-52 w-52 rounded-full bg-[#EFF6FF] blur-3xl" />
          ...
          <p className="relative mx-auto mt-3 max-w-2xl text-[#6B7280]">
        ...
        <section className="grid gap-10 py-12 lg:grid-cols-2">
          ...
          <div className="relative pl-6">
            <div className="absolute left-2 top-2 h-[88%] w-px bg-gradient-to-b from-[#2563EB] to-[#7C3AED]" />
            {[
              "2021: Founded",
        ...
        <section className="grid gap-5 md:grid-cols-2">
          {values.map((item) => {
            ...
            return (
              <article key={item.title} className="rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-[var(--shadow-sm)]" style={{ borderTop: `4px solid ${item.color}` }}>
        ...
        <section className="mt-10 grid gap-5 pb-8 md:grid-cols-3">
          {members.map((member) => (
            <article key={member.name} className="rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-[var(--shadow-sm)]">
              ...
              <p className="mt-2 text-sm text-[#6B7280]">Focused on fast, maintainable product delivery.</p>
            </article>
          ))}
        </section>
      </div>
